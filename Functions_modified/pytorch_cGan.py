...
def visualize_predictions(X_test, predicted_classes, true_classes, num_images=10):
    ...
    for i, idx in enumerate(indices):
        ...
        ax3.imshow(X_test[idx].squeeze(), cmap='gray')
...
predicted_classes1, true_classes1 = predict_and_visualize(model, X_test, y_test)

# Visualize a subset of test images with predictions
visualize_predictions(X_test, predicted_classes1, true_classes1, num_images=10)
