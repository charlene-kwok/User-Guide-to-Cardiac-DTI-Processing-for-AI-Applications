...
#from unwrap_functions import unwrap, vals_to_barcode
...
def unwrap_inner_(img1,mask1,pick_centre_algorithm=pick_centre_mean_):
    '''
    private function
...
def unwrap_outer_(img1,mask1,pick_centre_algorithm = pick_centre_mean_):
    '''
    private function
...
pick_centre_algorithm = pick_centre_mean_
centre_mean = pick_centre_mean_(alg_mask)
centre_middle = pick_centre_middle_(alg_mask)

#hs = copy.deepcopy(uw2(hs,14,3,True))
num_M=None
num_layers=None
return_contours=True
return_layer_maps=True


# hd2 = uw2(hd,14,3,True)
# oups2 = copy.deepcopy(uw2(hd,14,3,return_contours,return_layer_maps))
# N = None
# tol = 180
# unwrapped_img= vals_to_barcode_updated_method2_(oups,N)
...
# plt.figure(2)
# oups = []
# val_inner = unwrap_inner_(img1,mask1)
# val_outer = unwrap_outer_(img1,mask1)
# N = correct_N_(val_inner,val_outer)
# custom_tol = N
